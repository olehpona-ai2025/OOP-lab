...
import lab1.core.model.FarmEventType;
import lab1.core.model.FarmReport;
import lab1.service.AnalyticStore;
...
public class RamAnalyticStore implements AnalyticStore {
    ...
    private class Reporter implements lab1.service.Reporter {
    ...
    @Override
    public lab1.service.Reporter createrReporter() {
        return new Reporter();
    };
}
